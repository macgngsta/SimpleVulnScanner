...
public class SessionVariableTask extends AbstractTask
{
	public static final List<String> SEARCH_TOKENS = Arrays.asList("[");

	public SessionVariableTask(CommonTree t, MetaData m)
	{
		super(t, m);
	}
	...
	public void process()
	{
		...
		setNextTask(new VariableTask(prunedTree, this.meta));
